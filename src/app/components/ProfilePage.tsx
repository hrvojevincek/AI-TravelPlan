...
async function ProfilePage({
  ...
  return (
    <div className="flex bg-neutral-100">
      <aside
        className="min-w-[45%] h-screen shadow-xl transition-transform -translate-x-full sm:translate-x-0 bg-white"
        aria-label="Sidebar"
      >
        ...
        <div className="flex flex-col h-full items-stretch justify-between px-6 py-24 rounded-lg">
          ...
          <div className="flex flex-col items-center">
            <Link
              href="/"
              className="flex justify-center items-center p-2 rounded-lg cursor-pointer text-blue-500"
            >
